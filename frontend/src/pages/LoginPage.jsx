      ...
      <main className="flex-1 flex items-center justify-center py-24 px-6 bg-gray-50">
        <div className="max-w-md w-full p-16 bg-white shadow-2xl rounded-[3rem] border border-gray-100 relative overflow-hidden group">
          ...
          <header className="mb-12 text-center">
             <h2 className="text-4xl font-black uppercase tracking-tighter mb-4 text-gray-900">Welcome.</h2>
             <p className="text-[9px] font-black uppercase tracking-[0.3em] text-gray-400">Enter Credentials to Proceed</p>
          </header>
          ...
          <div className="mt-12 pt-12 border-t border-gray-50 space-y-6 text-center">
            <p className="text-[10px] font-black uppercase tracking-widest text-gray-400">
              No access? <Link to="/register" className="text-sky-500 hover:text-sky-600 transition-colors">Request Account</Link>
            </p>
          </div>
        </div>
      </main>
